...
void setup() {
  ...
  xTaskCreate(taskWiFiConnection, "Tarefa_WiFi", 3072, NULL,
              configMAX_PRIORITIES - 1, NULL);

  // Tarefa que verifica os valores de inclinação
  xTaskCreate(taskAccelerometerMPU6050, "taskAccelerometerMPU6050", 2048, NULL,
  ...
  xTaskCreate(taskServoMotor, "Tarefa_Servo", 2048, NULL,
  ...
  // Tarefa de GPS
  xTaskCreate(taskGPS, "Tarefa_GPS", 2048, NULL, configMAX_PRIORITIES - 5,
              NULL);
}
